About robotframework-stacktrace
===============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/robotframework-stacktrace-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13018&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/robotframework-stacktrace-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `robotframework-stacktrace` can be installed with:

```
conda install robotframework-stacktrace
```

It is possible to list all of the versions of `robotframework-stacktrace` available on your platform with:
